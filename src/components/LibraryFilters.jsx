    ...
    <FiltersContainer>
      <FilterGroup>
        ...
        <Tooltip title='Filtros avanzados'>
          <IconButton onClick={() => setShowAdvancedFilters(true)} sx={{ color: colorWhite }}>
            <FilterListIcon />
          </IconButton>
        </Tooltip>
      ...
      >
        ...
        >
          ...
          <IconButton onClick={() => setShowAdvancedFilters(false)} sx={{ color: colorWhite }}>
            <CloseIcon />
          </IconButton>
        </Box>
        ...
        <Stack spacing={3}>
          ...
          <Box>
            <Typography gutterBottom color={colorWhite} sx={{ mb: 2 }}>
              Duración (minutos)
            </Typography>
            <Slider
              value={durationRange}
          ...
          <FormControl fullWidth>
            <InputLabel sx={{ color: 'rgba(255, 255, 255, 0.7)' }}>Progreso</InputLabel>
            <Select
