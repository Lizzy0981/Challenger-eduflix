...
const NotificationItem = styled(ListItem)(({ theme, read, type }) => ({
  ...
  marginBottom: '0.8rem',
  padding: '1rem',
  background: read ? 'rgba(255, 255, 255, 0.05)' : `${getNotificationBackground(type)}`,
    ...
    <NotificationContext.Provider value={value}>
      ...
      >
        <Tooltip title='Notificaciones'>
          <IconButton onClick={() => setOpen(true)} sx={{ color: colorWhite }}>
      ...
      <NotificationDrawer anchor='right' open={open} onClose={() => setOpen(false)}>
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          <IconButton onClick={() => setOpen(false)} sx={{ color: colorWhite }}>
            <CloseIcon />
          </IconButton>
        </Box>
