...
function FormSearch() {
  ...
  return (
    <FormMain onSubmit={handleSubmit}>
      ...
      <FilterDrawer anchor='right' open={showFilters} onClose={() => setShowFilters(false)}>
        <FilterSection>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Typography variant='caption'>{formatDuracion(filters.duracion[0])}</Typography>
              <Typography variant='caption'>{formatDuracion(filters.duracion[1])}</Typography>
            </Box>
          </Box>
