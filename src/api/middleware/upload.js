...
export const uploadCertificate = createUploader(FILE_TYPES.certificate, 'certificates').single(
  'certificate'
)
  ...
  return async (req, res, next) => {
    ...
    try {
      ...
      if (dimensions.width > maxWidth || dimensions.height > maxHeight) {
        throw createError(
          400,
          `Las dimensiones de la imagen no deben exceder ${maxWidth}x${maxHeight}`
        )
      }
